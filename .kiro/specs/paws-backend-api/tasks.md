...
## Task 1: Bootstrap y configuración global de la API
...
## Task 2: Auth guards y decoradores de roles
...
## Task 3: Volunteers module — Registro y perfil
...
## Task 4: Volunteers module — Dashboard, actividad y recomendaciones
- [x] Requirement: R5, R8
...
## Task 5: Volunteers module — Aplicaciones del voluntario
- [x] Requirement: R7
...
## Task 6: Shelters module — Registro y listado
...
- [x] Add `getRecentApplications(userId)` to SheltersService: query last 10 applications for shelter's opportunities, join volunteer names, format time relative
...
## Task 8: Opportunities module — Listado público y detalle
- [x] Requirement: R3
...
## Task 9: Opportunities module — CRUD por refugio
- [x] Requirement: R9
...
## Task 10: Applications module — Gestión por refugio
- [x] Requirement: R10
...
## Task 11: Verificación de compilación y arranque
