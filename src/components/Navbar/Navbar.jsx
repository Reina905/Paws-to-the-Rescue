    ...
    <>
      <nav className={`flex py-4 w-full items-center px-10 z-9999 ${scrolled ? 'bg-tertiary-light bg-opacity-5 text-primary fixed shadow-sm transition-all ease-in-out' : ''}`}>
        ...
        <div className='links flex justify-center gap-4'>
          <Link to="/" className={`relative py-2 px-3 transition-all duration-300 ${scrolled ? "hover:text-text-primary": "hover:text-secondary"}
                                  after:absolute
                                  after:left-0
                                  after:bottom-0
                                  after:h-0.5
          ...
          <Link to="/volunteering" className={`relative py-2 px-3 transition-all duration-300 ${scrolled ? "hover:text-text-primary": "hover:text-secondary"}
                                  after:absolute
                                  after:left-0
                                  after:bottom-0
                                  after:h-0.5
